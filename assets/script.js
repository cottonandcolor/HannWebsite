...
async function submitLeadForm(form, submitBtn, successEl, defaultLabel, subjectPrefix) {
  ...
  try {
    const response = await fetch('https://formsubmit.co/ajax/hannahmara23@gmail.com', {
      method: 'POST',
...
Thank you.`
    ...
    window.location.href = `mailto:hannahmara23@gmail.com?subject=${subject}&body=${body}`;
  } finally {
    if (submitBtn) {
